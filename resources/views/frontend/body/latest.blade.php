...
<div class="container-fluid">
    <div class="row">
        <div class="gap-1 p-2 col-12 col-md-9">
            <h1 class="h3">{{ GoogleTranslate::trans("Latest News", app()->getLocale()) }}</h1>
            <div class="row">
                    ...
                    <div class="my-3 col-12 col-md-4">
                        <a href="{{ url('newspost/details/'.$newsList->id."/".$newsList->news_title_slug) }}" class="text-decoration-none text-secondary">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="card-text ">{!! Str::limit(GoogleTranslate::trans($newsList->news_details, app()->getLocale()), 60) !!}</p>
